...
profile=tempfile.mkdtemp(prefix='colorize-v029-');log=open('/tmp/colorize-v029-chrome.log','w+b')
...
try:
    ...
    url=f'http://127.0.0.1:{PORT}/?v029-inline=1'
